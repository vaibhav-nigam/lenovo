...
const Search = () => {
  return (
    <div className="max-w-[12480px] mx-auto grid lg:grid-cols-3 gap-4 px-4 py-16">
      <div className="lg:col-span-2 flex flex-col justify-evenly">
        ...
        <div className="grid sm:grid-cols-2 gap-8 py-4">
          ...
          <div className="flex flex-col lg:flex-row items-center text-center">
            ...
            <div>
              <h3 className="py-2 ">24x7 SERVICE</h3>
              <p className="py-1">
              Premium Plus 24x7 customers receive priority support with business-hours.
              </p>
            </div>
          </div>
        </div>
